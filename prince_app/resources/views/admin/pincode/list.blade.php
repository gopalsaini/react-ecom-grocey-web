    ...
    <div class="container-fluid">
				...
				<div class="card">
					...
					<div class="body">
						<div class="btn-group top-head-btn">
                            <a class="btn-primary" href="{{ url('admin/pincode/add') }}">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Pincode List</h2>
					</div>
                    <div class="body">
                        <div class="table-">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="center sorting" tabindex="0"
                                                        ...
                                                        aria-label=" Mobile : activate to sort column ascending"> Pincode
                                                    </th>
														...
														<tr class="gradeX odd">
															...
															@if(\Auth::user()->designation_id=='1' || \Auth::user()->designation_id=='4')
																...
																<td class="center">
																	...
																	<a href="{{ url('admin/pincode/update/'.$value['id'] )}}" title="Edit Pincode" class="btn btn-tbl-edit">
																		<i class="fas fa-pencil-alt"></i>
																	</a>
																	<a title="Delete Pincode" onclick="return confirm('Are you sure? You want to delete this pincode.')" href="{{ url('admin/pincode/delete/'.$value['id'] )}}" class="btn btn-tbl-delete">
