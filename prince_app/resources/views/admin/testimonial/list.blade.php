    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Testimonial List</h2>
					</div>
                    <div class="body">
                        <div class="table-">
												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd">
															...
															<td class="center">
																<img src="{{ asset('uploads/testimonial/'.$value['image'] )}}" style="width:100px"/>
															</td>
															<td class="center">{{ ucfirst($value->name) }}</td>
															<td class="center">{{ ucfirst($value->designation) }}</td>
															...
															@if(\Auth::user()->designation_id=='1' || \Auth::user()->designation_id=='4')
																...
																<td class="center">
																	...
																	<a href="{{ url('admin/testimonial/update/'.$value['id'] )}}" title="Update Testimonial" class="btn btn-tbl-edit">
